...
//        TextView txt = (TextView) layout.findViewById(R.id.custom_toast_message);
//        txt.setText("WAIT !! " + "\n" + "We are configuring your Camera for Augmentation !!");
...
//            View layout = inflater.inflate(R.layout.custom_toast, (ViewGroup) findViewById(R.id.custom_toast_layout));
//            TextView txt = (TextView) layout.findViewById(R.id.custom_toast_message);
//            txt.setText("Almost there, Few more seconds !!");
//            Toast toast = new Toast(getApplicationContext());
//            toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
//            toast.show();
...
//                View layout = inflater.inflate(R.layout.custom_toast, (ViewGroup) findViewById(R.id.custom_toast_layout));
//                TextView txt = (TextView) layout.findViewById(R.id.custom_toast_message);
//                txt.setText("YES" + "\n" + "Thank You for your patience, The furniture is ready to get Augmented !!");
//                Toast toast = new Toast(getApplicationContext());
//                toast.setGravity(Gravity.CENTER_VERTICAL, 0, 0);
//                toast.show();
