...
public class fav_Dots extends View {
    ...
    public fav_Dots(Context context) {
        super(context);
        init();
    }


    public fav_Dots(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public fav_Dots(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public static final Property<fav_Dots, Float> DOTS_PROGRESS = new Property<fav_Dots, Float>(Float.class, "dotsProgress") {
        @Override
        public Float get(fav_Dots object) {
            return object.getCurrentProgress();
        }

        @Override
        public void set(fav_Dots object, Float value) {
